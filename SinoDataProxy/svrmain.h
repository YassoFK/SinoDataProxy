...
private:
    ...
    strsvr_t strsvr;
public:
    explicit MainForm(QString name,QWidget *parent=0);

signals:
    void sendInputStr(connectedit edit);
    void sendTime(QString strname,QString,QString,QString,QString);
    void sendStopStatus(QString);
};
//---------------------------------------------------------------------------
#endif
